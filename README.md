...
- [Cómo hacer un fork del repositorio y arrancar el proyecto](#cómo-hacer-un-fork-del-repositorio-y-arrancar-el-proyecto)
  - [1. Hacer un fork en GitHub](#1-hacer-un-fork-en-github)
  - [2. Requisitos previos](#2-requisitos-previos)
  - [3. Instalar Silence](#3-instalar-silence)
  - [4. Configurar la base de datos](#4-configurar-la-base-de-datos)
  - [5. Crear las tablas y cargar datos de ejemplo](#5-crear-las-tablas-y-cargar-datos-de-ejemplo)
  - [6. Arrancar el servidor](#6-arrancar-el-servidor)
  - [7. Regenerar los ficheros JS de la API (si cambias los endpoints)](#7-regenerar-los-ficheros-js-de-la-api-si-cambias-los-endpoints)
- [1. Cómo crear un proyecto desde cero con Silence](#1-cómo-crear-un-proyecto-desde-cero-con-silence)
  - [¿Qué es Silence?](#qué-es-silence)
  - [Crear un proyecto nuevo](#crear-un-proyecto-nuevo)
  - [El fichero settings.py](#el-fichero-settingspy)
  - [Definir endpoints (API REST)](#definir-endpoints-api-rest)
  - [Definir la base de datos](#definir-la-base-de-datos)
  - [Flujo de trabajo típico](#flujo-de-trabajo-típico)
- [2. Cómo escribir una página en HTML](#2-cómo-escribir-una-página-en-html)
  - [¿Qué es HTML?](#qué-es-html)
  - [Estructura básica de un documento HTML](#estructura-básica-de-un-documento-html)
  - [Todas las etiquetas HTML usadas en este proyecto](#todas-las-etiquetas-html-usadas-en-este-proyecto)
    - [Etiquetas de estructura y metadatos](#etiquetas-de-estructura-y-metadatos)
    - [Etiquetas de contenido y semánticas](#etiquetas-de-contenido-y-semánticas)
    - [Etiquetas de formulario](#etiquetas-de-formulario)
    - [Atributos importantes usados en el proyecto](#atributos-importantes-usados-en-el-proyecto)
  - [Cómo estructurar correctamente una página web](#cómo-estructurar-correctamente-una-página-web)
    - [1. Un patrón consistente en todas las páginas](#1-un-patrón-consistente-en-todas-las-páginas)
    - [2. Separar la cabecera en un fichero reutilizable](#2-separar-la-cabecera-en-un-fichero-reutilizable)
    - [3. Usar indentación consistente](#3-usar-indentación-consistente)
    - [4. Separar estructura (HTML), estilo (CSS) y comportamiento (JS)](#4-separar-estructura-html-estilo-css-y-comportamiento-js)
    - [5. Usar IDs para elementos únicos y clases para estilos repetibles](#5-usar-ids-para-elementos-únicos-y-clases-para-estilos-repetibles)
    - [6. Agrupar lógicamente con divs y clases de Bootstrap](#6-agrupar-lógicamente-con-divs-y-clases-de-bootstrap)
    - [7. Usar comentarios para secciones importantes](#7-usar-comentarios-para-secciones-importantes)
    - [8. Colocar los scripts al final del body](#8-colocar-los-scripts-al-final-del-body)
- [3. Cómo implementar estilos con CSS](#3-cómo-implementar-estilos-con-css)
  - [¿Qué es CSS?](#qué-es-css)
  - [Cómo escribir CSS: selectores y formas de aplicar estilos](#cómo-escribir-css-selectores-y-formas-de-aplicar-estilos)
    - [Las tres formas de aplicar CSS](#las-tres-formas-de-aplicar-css)
    - [Tipos de selectores CSS](#tipos-de-selectores-css)
    - [Prioridad de los selectores (Especificidad)](#prioridad-de-los-selectores-especificidad)
  - [Propiedades CSS responsivas y animaciones](#propiedades-css-responsivas-y-animaciones)
    - [Diseño responsivo](#diseño-responsivo)
    - [Animaciones CSS (@keyframes)](#animaciones-css-keyframes)
    - [Efecto stagger (escalonado) en tarjetas](#efecto-stagger-escalonado-en-tarjetas)
    - [Transiciones CSS](#transiciones-css)
    - [Glow en la marca de navegación](#glow-en-la-marca-de-navegación)
  - [Cómo usar Bootstrap en profundidad](#cómo-usar-bootstrap-en-profundidad)
    - [¿Qué es Bootstrap?](#qué-es-bootstrap)
    - [Sistema de Grid (cuadrícula)](#sistema-de-grid-cuadrícula)
    - [Clases de utilidad (las más usadas en el proyecto)](#clases-de-utilidad-las-más-usadas-en-el-proyecto)
    - [Componentes de Bootstrap usados en el proyecto](#componentes-de-bootstrap-usados-en-el-proyecto)
    - [Cómo organizar las clases en HTML con Bootstrap](#cómo-organizar-las-clases-en-html-con-bootstrap)
    - [Font Awesome (iconos)](#font-awesome-iconos)
- [4. Cómo usar JavaScript](#4-cómo-usar-javascript)
  ...
  - [Conceptos fundamentales de JavaScript](#conceptos-fundamentales-de-javascript)
    ...
    - [Template literals (cadenas con interpolación)](#template-literals-cadenas-con-interpolación)
  ...
  - [El DOM (Document Object Model)](#el-dom-document-object-model)
    - [Seleccionar elementos](#seleccionar-elementos)
    - [Modificar elementos](#modificar-elementos)
    - [Crear elementos](#crear-elementos)
    - [Eventos](#eventos)
  - [Programación asíncrona: async / await](#programación-asíncrona-async--await)
    - [Promesas](#promesas)
    - [async / await](#async--await)
  - [Módulos ES6 (import / export)](#módulos-es6-import--export)
    - [Exportar](#exportar)
    - [Importar](#importar)
  - [Uso de 'use strict'](#uso-de-use-strict)
  - [localStorage (almacenamiento en el navegador)](#localstorage-almacenamiento-en-el-navegador)
  - [Peticiones HTTP con Axios](#peticiones-http-con-axios)
    - [Configuración base (common.js)](#configuración-base-commonjs)
    - [Hacer peticiones](#hacer-peticiones)
    - [Ficheros de API autogenerados](#ficheros-de-api-autogenerados)
  - [Patrón completo: de la página al servidor](#patrón-completo-de-la-página-al-servidor)
    - [Ejemplo 1: Renderizar la galería de fotos (photos.js)](#ejemplo-1-renderizar-la-galería-de-fotos-photosjs)
    - [Ejemplo 2: Manejar el login (login.js)](#ejemplo-2-manejar-el-login-loginjs)
    - [Ejemplo 3: Navegación según sesión (sessionNav.js)](#ejemplo-3-navegación-según-sesión-sessionnavjs)
    - [Ejemplo 4: Incluir la cabecera (include.js)](#ejemplo-4-incluir-la-cabecera-includejs)
    - [Ejemplo 5: Mostrar mensajes (messages.js)](#ejemplo-5-mostrar-mensajes-messagesjs)
    - [Ejemplo 6: Pasar datos entre páginas (URLSearchParams)](#ejemplo-6-pasar-datos-entre-páginas-urlsearchparams)
  - [Resumen del flujo de datos del proyecto](#resumen-del-flujo-de-datos-del-proyecto)
